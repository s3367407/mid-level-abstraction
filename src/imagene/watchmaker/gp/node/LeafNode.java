...
{
    /**
     * The arity of a non-function gp.node is always zero.
     * @return 0
     */
    public int getArity()
    {
    ...
    public Node getNode(int index)
    {
        if (index != 0)
        {
            throw new IndexOutOfBoundsException("Invalid gp.node index: " + index);
        }
        return this;
    }
    ...
    public Node mutate(Random rng, Probability mutationProbability, TreeFactory treeFactory)
    {
        ...
        {
            // gp.gp.node.gp.node.Node is unchanged.
            return this;
        }
    }
    ...
    /**
     * Returns this gp.node (leaf nodes cannot be simplified).
     * @return This gp.node, unmodified.
     */

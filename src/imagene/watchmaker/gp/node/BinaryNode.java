package imagene.watchmaker.gp.node;
...
public abstract class BinaryNode implements Node
{
     ...
     * @param symbol A string that indicates the type of function.
     */
    ...
    /**
     * The arity of a binary gp.node is two.
     * @return 2
     */
    public int getArity()
    {
    ...
    /**
     * The depth of a binary gp.node is the depth of its deepest sub-gp.tree plus one.
     * @return The depth of the gp.tree rooted at this gp.node.
     */
    public int getDepth()
    {
    ...
    /**
     * The width of a binary gp.node is the sum of the widths of its two sub-trees.
     * @return The width of the gp.tree rooted at this gp.node.
     */
    public int getWidth()
    {
